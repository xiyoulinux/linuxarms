...
{		
	struct hssinfo_struct *hssinfo = linuxarms->hsthread->hssinfo;
        ...
        label_hostname = gtk_label_new(_("<b>主机名：</b>"));
	...
	hssinfo->widget.hostname = label_hostname;
	hssinfo->widget.release = label_release;
	hssinfo->widget.kernel = label_kernel;
	hssinfo->widget.memory = label_memory;
	hssinfo->widget.netrecv = label_netrecv;
	hssinfo->widget.netsend = label_netsend;
	hssinfo->widget.cpuinfo = label_cpuinfo;
	hssinfo->widget.cpuused = label_cpuused;
	hssinfo->widget.cpuload = label_cpuload;
	hssinfo->widget.disk = label_disk;
